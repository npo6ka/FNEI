...
function fnei.main_gui.open_main_gui(player)
  ...
  ui.add({type = "flow", name = "fnei_element_list", direction = "horizontal"})
    ...
    search_line.add({type = "sprite-button", name = "fnei_main_settings_key", style = "slot_button_style", tooltip = {"fnei.settings-key"}, sprite = "fnei_settings_key"})
    search_line.add({type = "sprite-button", name = "fnei_main_exit_key", style = "slot_button_style", tooltip = {"fnei.exit-key"}, sprite = "fnei_exit_key"})
