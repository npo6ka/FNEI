      ...
      local main_table = main_frame.add({type = "table", name = "fnei_recipe_main_table", colspan = 1, style = "fnei_recipe_main_table"})
        local header = main_table.add({type = "frame", name = "fnei_recipe_header_frame", direction = "horizontal", style = "fnei_recipe_header_frame"})
          local header_tab = header.add({type = "table", name = "fnei_recipe_header_table", colspan = 5, style = "fnei_recipe_header_table"})
            ...
            header_tab.add({type = "sprite-button", name = "fnei_recipe_back_key", style = "slot_button_style", tooltip = {"fnei.back-key"}, sprite = "fnei_back_key"})
            header_tab.add({type = "sprite-button", name = "fnei_recipe_settings_key", style = "slot_button_style", tooltip = {"fnei.settings-keyback-key"}, sprite = "fnei_settings_key"})
            header_tab.add({type = "sprite-button", name = "fnei_recipe_exit_key", style = "slot_button_style", tooltip = {"fnei.exit-key"}, sprite = "fnei_exit_key"})
